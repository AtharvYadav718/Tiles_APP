...
namespace Tiles_APP
{
    public partial class Frm_Product_List : Form
    {
        ...
        private void Frm_Product_List_Load(object sender, EventArgs e)
        {
            ...
            Bind_ComboBox();
            Tiles_App_Sherard_Content.Bind_Grid(dgv_Product_List, "Select * From Product_Details");
        }
        ...
        private void cmb_Subcategory_Name_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Tiles_App_Sherard_Content.Bind_Grid(dgv_Product_List, "Select * From Product_Details where Category_Name = '" + Cmb_Category_Name.Text + "' And Subcategory_Name = '" + cmb_Subcategory_Name.Text + "'");
            Tiles_App_Sherard_Content.Con_Close();
        }

        private void cmb_Product_Name_SelectedIndexChanged(object sender, EventArgs e)
        {
            Tiles_App_Sherard_Content.Bind_Grid(dgv_Product_List, "Select * From Product_Details where Category_Name = '" + Cmb_Category_Name.Text + "' And Subcategory_Name = '" + cmb_Subcategory_Name.Text + "' And Product_Name = '" + cmb_Product_Name.Text + "' ");
        }
